...
class Draft extends React.Component {
    constructor(props) {
      ...
      this.onChange = (editorState) =>{
        ...
        this.props.contentToDB(JSON.stringify(convertToRaw(contentState)));
      } 
    ...
    componentDidMount() {
      ...
      if (description && !preview) {
        this.setState({ editorState: EditorState.createWithContent(convertFromRaw(JSON.parse(description))) })
      } else {
    ...
    render() {
      ...
      if(!this.state.hasOwnProperty('editorState')) return <Loading/>
